...
.. autoapisummary::
   ...
   paidiverpy.metadata_parser.metadata_parser.filename_columns
   paidiverpy.metadata_parser.metadata_parser.index_columns
   paidiverpy.metadata_parser.metadata_parser.datetime_columns
   paidiverpy.metadata_parser.metadata_parser.lat_columns
   paidiverpy.metadata_parser.metadata_parser.lon_columns
...
.. py:data:: filename_columns
   :value: ['image-filename', 'filename', 'file_name', 'FileName', 'File Name']


.. py:data:: index_columns
   :value: ['id', 'index', 'ID', 'Index', 'Id']


.. py:data:: datetime_columns
   :value: ['image-datetime', 'datetime', 'date_time', 'DateTime', 'Datetime']


.. py:data:: lat_columns
   :value: ['image-latitude', 'lat', 'latitude_deg', 'latitude', 'Latitude', 'Latitude_deg', 'Lat']


.. py:data:: lon_columns
   :value: ['image-longitude', 'lon', 'longitude_deg', 'longitude', 'Longitude', 'Longitude_deg', 'Lon']

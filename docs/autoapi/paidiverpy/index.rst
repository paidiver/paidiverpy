...
.. toctree::
   ...
   /autoapi/paidiverpy/colour_layer/index
   /autoapi/paidiverpy/config/index
   /autoapi/paidiverpy/convert_layer/index
   /autoapi/paidiverpy/custom_layer/index
   /autoapi/paidiverpy/images_layer/index
   /autoapi/paidiverpy/metadata_parser/index
   /autoapi/paidiverpy/open_layer/index
   /autoapi/paidiverpy/paidiverpy/index
   /autoapi/paidiverpy/pipeline/index
   /autoapi/paidiverpy/position_layer/index
   /autoapi/paidiverpy/resample_layer/index
   /autoapi/paidiverpy/utils/index
...
.. py:class:: Paidiverpy(config_params: dict | paidiverpy.config.config_params.ConfigParams = None, config_file_path: str | None = None, config: paidiverpy.config.config.Configuration = None, metadata: paidiverpy.metadata_parser.MetadataParser = None, images: paidiverpy.images_layer.ImagesLayer = None, client: dask.distributed.Client | None = None, paidiverpy: Paidiverpy = None, track_changes: bool | None = None, logger: logging.Logger | None = None, raise_error: bool = False, verbose: int = 2)
   ...
   .. py:method:: _set_variables_from_paidiverpy(paidiverpy: Paidiverpy) -> None
   ...
   .. py:method:: _initialise_config(config_file_path: str, config_params: paidiverpy.config.config_params.ConfigParams | dict) -> paidiverpy.config.config.Configuration
      ...
      :type config_params: Union[ConfigParams, dict]
   ...
   .. py:method:: _initialize_metadata() -> paidiverpy.metadata_parser.MetadataParser
   ...
   .. py:method:: _calculate_steps_metadata(config_part: paidiverpy.config.config.Configuration) -> dict

      
      Calculate the steps metadata.

      :param config_part: The configuration part.
      :type config_part: Configuration

      :returns: The steps metadata.
      :rtype: dict
   ...
   .. py:method:: _get_method_by_mode(params: paidiverpy.utils.dynamic_classes.DynamicConfig, method_dict: dict, mode: str, class_method: bool = True) -> tuple
      ...
      :type params: DynamicConfig
      :param method_dict: The method dictionary.
      :type method_dict: dict
      :param mode: The mode.
      :type mode: str
      :param class_method: Whether the method is a class method.
                           Defaults to True.
      :type class_method: bool, optional

      :raises ValueError: Unsupported mode.

      :returns: The method and parameters.
      :rtype: tuple

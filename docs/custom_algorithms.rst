...
For a more concrete example, consider the following code snippet (available in `examples/custom_algorithms files <https://github.com/paidiver/paidiverpy/tree/develop/examples/custom_algorithms>`_ of the `paidiverpy` package):
